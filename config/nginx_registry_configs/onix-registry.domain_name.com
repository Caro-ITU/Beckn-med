server {
    listen 80;
    listen [::]:80;
    server_name onix-registry.domain_name.com;
...
server {
    ...
    ssl_certificate /etc/letsencrypt/live/onix-registry.domain_name.com/fullchain.pem;
    ssl_certificate_key /etc/letsencrypt/live/onix-registry.domain_name.com/privkey.pem;
